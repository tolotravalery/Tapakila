...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('shopping/cart')->withSuccessMessage('Item was added to your cart!');
    }
    ...
    {
        Cart::remove($id);
        return redirect('shopping/cart')->withSuccessMessage('Item has been removed!');
    }
    ...
    {
        Cart::destroy();
        return redirect('shopping/cart')->withSuccessMessage('Your cart has been cleared!');
    }
