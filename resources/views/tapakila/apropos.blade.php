        ...
        <div class="row performe">
            <div class="col-md-9">
                <div class="about-bg">
                    ...
                    <p>Ressentir le public vibrer avant les premières notes, vivre intensément un moment unique, il y a
                    ...
                    <p>La recette est simple : une équipe de passionnés et un service client aux petits soins. Tous nos
                    ...
                    <h3>NOS TARIFS</h3>
                    <p>Nos tarifs diffèrent généralement de ceux des billetteries traditionnelles. En fonction de
                        l’évolution de la demande dans le temps, les prix peuvent en effet être ajustés pour chaque
                        évènement.</p>
                    <p>Les prix peuvent ainsi varier au fil du temps, à la hausse comme à la baisse, et s'éloigner du
                    ...
                    <p>Pour les évènements à très forte affluence, un service de pré-réservation est susceptible d’être
                    ...
                    <p>Si un évènement vous intéresse, n’hésitez pas à nous contacter pour demander la mise en place
                        d’une pré-réservation.</p><br>

                    <h3>ORGANISATEURS D'ÉVÈNEMENTS</h3>
                    <p>Vous souhaitez distribuer vos billets via un canal de distribution innovant, et assurer une
                        expérience optimale à vos clients? Vous avez frappé à la bonne porte. Voir FAQ en bas de
                        page</p><br>

                    <h3>SERVICE CORPORATE</h3>
                    <p>Demandes de groupes, entreprises, conciergeries… Ne cherchez plus, notre équipe spécialisée prend
                    ...
                    <h3>LA GARANTIE TAPAKILA</h3>
                    <p><b>Quand vous achetez sur TAPAKILA, vous profitez des avantages suivants :</b></p>
                    <ul>
