        ...
        <div class="row performe">
            <div class="col-md-12">
                <div class="about-bg">
                    ...
                    <p style="text-align: justify;">La recette est simple : une équipe de passionnés et un service client aux petits soins. Tous nos billets sont authentiques, côte à côte, garantis, et expédiés avec le sourire en temps réel. Vous pouvez enfin assister aux évènements qui comptent pour vous, et ce en toute sérénité.</p>
                    <h3>NOS TARIFS</h3>
                    ...
                    <p style="text-align: justify;">Pour les évènements à très forte affluence, le service de préréservation sur leguichet.mg est de consulter quotidiennement notre site, car des fois au début de publication d’un évènement les billets ne sont pas encore disponibles. Le premier paiement est la première réservation et le dernier paiement est la dernière réservation </p>
                    ...
                    <p style="text-align: justify;"><b>Quand vous achetez sur Leguichet, vous profitez des avantages suivants :</b></p>
                    <ul>
