@extends('template')
@section('title')
    <title>Le Guichet | A propos de nous</title>
        ...
        <div class="row performe">
            <div class="col-md-12">
                <div class="about-bg">
                    ...
                    <p style="text-align: justify;">La recette est simple : une équipe de passionnés et un service client aux petits soins. Tous nos billets sont authentiques,garantis, et expédiés  en temps réel. Vous pouvez enfin assister aux évènements qui comptent pour vous, en toute sérénité.</p>
