                                        ...
                                        <div class="panel-body">
                                            <p onclick="accord()"><span style="cursor: pointer"> Comment acheter les billets sur leguichet ?</span>
                                                ...
                                                <label id="demo" class="hidden padd">
                                                    Acheter des billets sur Tapalika est très simple, il vous suffit de suivre les instructions ci-dessous:
                                                    <br>
                                            ...
                                            <p onclick="accord4()"><span style="cursor: pointer">Puis-je acheter des billets personnalisé sur lesquels figure le nom de quelqu'un d'autre ?</span>
                                                ...
                                                <label id="demo4" class="hidden padd">
                                                    Oui, Tapalika autorise des vendeurs tiers, notamment des particulier, à mettre en ventedes billets sur sa plateforme. Il se peut que le nom de l'acheteur d'origine figure sur les billet, ces billets sont valables. Vous n'êtes pas obligé(e) de posséder un billet à votre nom pour accéder à l'événement.
                                                </label>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <p onclick="accord13()"><span style="cursor: pointer">Quelles sont les méthodes de paiement acceptées ? ?</span>
                                                ...
                                                <label id="demo13" class="hidden padd">
                                                    leguichet accepte la plupart des cartes de crédit, PayPal, ainsi que les transferts bancaires directs dans certains pays.
                                                    <br>
                                            ...
                                            <p onclick="accord14()"><span style="cursor: pointer">Mon paiement a été refusé</span>
                                                ...
                                                <label id="demo14" class="hidden padd">
                                                    ...
                                                    <br>
                                                    <br> • Essayez une carte de crédit internationale telle que Visa, Mastercard ou American Express, si cela n'est pas déjà fait. • Vérifiez que le code de sécurité (appelé également CVV2 ou CVC2) est correct. Pour Visa, Mastercard, Maestro, Switch and Electron, il s'agit des 3 chiffres au verso de votre carte de débit. Pour American Express, il s'agit des 4 chiffres se trouvant au recto, à droite de votre carte. • Assurez-vous que les informations de la carte de débit ou de crédit que vous avez saisies concernent une carte valide non expirée et disposant des fonds suffisants pour honorer cette commande. • Contactez votre banque ou la société émettrice de votre carte bancaire pour vérifier l'autorisation de paiement à leguichet. • Réglez par PayPal, un service gratuit pour payer en ligne sans partager vos informations financières.
                                                    <br>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse-4" role="tabpanel" aria-labelledby="header-4" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                        <div class="panel-body">
                                            ...
                                            <p onclick="accord19()"><span style="cursor: pointer">Comment se désinscrire de la newsletter ?</span>
                                                <br>
                                                <label id="demo19" class="hidden padd">
                                                    Les deux principales raisons pour lesquelles les clients ne voient pas leur commande ou leur vente sont:
                                                    <br>
                                                    <br> Il se peut que vous soyez connecté sur le mauvais compte Il est probable que vous ayez effectué votre achat en étant connecté depuis un deuxième compte à l'aide de l'une de vos autres adresses email, ou par le bais de Facebook.
                                                    <br>
                                                    <br> Vous avez fait une faute de frappe dans votre adresse email en utilisant la procédure de paiement pour invité Lorsque vous payez en tant qu'invité, l'adresse email que vous entrez deviend l'adresse email de votre compte et celle grâce à laquelle vous pourrez trouver votre commande.
                                                    <br>
                                                    <br> Afin de résoudre ceci:
                                                    <br>
                                                    <br> 1 - Consultez vos Paramètres de Compte et prenez note de l'adresse email de ce compte.
                                                    <br>
                                                    <br> 2 - Déconnectez-vous et tentez de vous reconnecter à l'aide d'une autre adresse email que vous pouvez avoir, ou bien à l'aide de Facebook, afin de voir si vous possédez un deuxième compte sur lequel votre commande pourrait se trouver.
                                                    <br>
                                                    <br> 3 - Si vous ne parvenez toujours pas à trouver votre commande ou vente, rendez-vous sur notre page mot de passe oublié / aide à la connection.
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <p onclick="accord22()"><span style="cursor: pointer">Que recouvrent les frais leguichet ?</span>
                                                ...
                                                <label id="demo22" class="hidden padd">
                                                    Acheteur : leguichet facture des frais de service venant s'ajouter au prix du billet. Ces frais sont indiqués clairement au cours du processus de paiement et ils servent à couvrir les frais de gestion de la plate-forme Tapalika, du service client et d'envoi des billets.
                                                    <br>
                                            ...
                                            <p onclick="accord23()"><span style="cursor: pointer">Quelles sont les Termes et Conditions de leguichet ? </span>
                                                ...
                                                <label id="demo23" class="hidden padd">
                                                    ...
                                                    <br>
                                                    <br> La société Tapalika Entertainment Inc, immatriculée au Madagascar, Vous propose sur le site Internet disponible à l’adresse www.Tapalika.com un service de mise en relation (ci-après la « Plateforme Tapalika ») entre vendeurs (les « Vendeurs ») de billets de spectacles ou événements sportifs (les « Billets ») et acheteurs (les « Acheteurs ») de ces mêmes Billets. Les Vendeurs et les Acheteurs sont ci-après désignés conjointement les Membres. La Plateforme Tapalika permet la conclusion de contrats de vente des Billets. Toutefois, les Membres sont seuls décisionnaires de la concrétisation de la vente et de l'achat des Billets.
                                                    <br>
                                                    <br> L'acceptation des présentes Conditions générales d'utilisation de la Plateforme Tapalika par les Membres Vous permet d’accéder à cette plateforme servant à mettre en relation Vendeurs et Acheteurs et à opérer les transactions effectuées sur le site www.Tapalika.com selon les modalités définies ci-après.
                                                    <br>
                                                    <br> DÉFINITIONS
                                                    ...
                                                    <br>
                                                    <br> Plateforme Tapalika : désigne la structure fonctionnelle et organisationnelle mise en place par Tapalika sur le Site permettant la mise en relation de Vendeurs et d'Acheteurs de Billets.
                                                    <br>
                                                    <br> Billet(s) : désigne les billets de spectacle ou d’événements sportifs en Madagascar ou à l’étranger, susceptibles de faire l'objet d'une mise en relation par le biais de la Plateforme Tapalika.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Vendeur(s) : désigne un Membre mettant en vente un Billet sur la Plateforme Tapalika, et éditant à cet effet une Offre de Vente sur le Site, dans le respect des conditions définies à l’article 3.1 des présentes Conditions Générales d’Utilisation.
                                                    <br>
                                                    <br> Acheteur(s) : désigne un Membre ayant accepté l'offre d'un Vendeur.
                                                    <br>
                                                    <br> Membre(s) ou Vous : désigne toute personne, Vendeur ou Acheteur, susceptible de faire usage de la Plateforme Tapalika après acceptation des présentes Conditions Générales d’Utilisation. Tout Membre s'engage à fournir des informations exactes quant à son identité, adresse et autres données nécessaires à l'accès à la Plateforme Tapalika et à mettre à jour toute modification concernant ces informations.
                                                    <br>
                                                    <br> Offre de Vente ou Listing : désigne toute annonce ou offre de vente d’un Billet éditée par un Vendeur sur la Plateforme Tapalika, incluant au moins une description des caractéristiques du Billet proposé à la Vente (date et lieu de la manifestation auquel le Billet donne accès, référence des places ou catégories de places auxquelles le Billet donne accès, etc.) et un Prix de Vente proposé.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Commission : désigne la rémunération perçue par Tapalika sur le Prix de Vente lors de la vente d’un Billet.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Service(s) : désigne tous les services offerts sur le site www.Tapalika.com.
                                                    <br>
                                                    <br> Site : désigne le site<a href="#"> www.Tapalika.com.</a>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Tapalika ou Nous : désigne la société Tapalika Entertainment Inc, sise à 160 Greentree Drive, Suite 101, Dover, Delaware, Country of Kent, 19904, Madagascar d’Amérique.
                                                    <br>
                                                    <br> 1.1 Introduction : Les présentes Conditions Générales d'Utilisation de la Plateforme Tapalika ont pour objet de définir les modalités de l'accord entre Vous et Nous, les conditions par lesquelles les Membres sont autorisés à utiliser la Plateforme Tapalika aux fins d'opérer leur mise en relation et tous les autres Services que Nous offrons. Par l'utilisation de ce Site et des Services, Vous confirmez accepter cet Accord et l’intégralité de ses termes.
                                                    <br>
                                                    <br> 1.2 Mise en relation : Tapalika offre à ses Membres de mettre en relation Acheteurs et Vendeurs de Billets. Tapalika ne devient pas propriétaire des Billets et les transactions sont effectuées entre les Acheteurs et les Vendeurs. Nous n'intervenons pas dans la transaction entre Acheteurs et Vendeurs. En conséquence, Nous n'exerçons aucun contrôle sur la qualité, la sûreté ou la licéité des Billets, la véracité ou l'exactitude du contenu ou des Offres de Vente des Membres, la capacité des Vendeurs à vendre ni la capacité des Acheteurs à payer les Billets. Nous ne pouvons pas non plus assurer que le Vendeur ou l'Acheteur concluront la transaction.
                                                    <br>
                                                    <br> 1.3 Commissions et Services : L'inscription, la mise en vente d’un Billet et l'action de se porter acquéreur de Billets proposés sur notre Site sont gratuites. Cependant, l'utilisation d'autres Services, tels que l’achat effectif d’un Billet, est payante. Lorsque Vous mettez en vente un Billet, Vous avez la possibilité de passer en revue les taux de Commission tels qu’ils sont détaillés dans la rubrique « Quels frais de gestion sont déduits du prix de vente » des pages d’aide du Site disponibles à l’adresse URL suivante http://www.Tapalika.com/service-clientele.html. Vous devez accepter ces tarifs pour mettre en ligne votre Offre de Vente. Sauf mention contraire, les taux de Commission sont indiqués sous forme de pourcentage du Prix de Vente et sont facturés en AR (Ariary).
                                                    <br>
                                                    <br> 1.4 Garantie Tapalika : Lorsque Vous achetez des billets sur Tapalika, Tapalika vous garantit que vous recevrez les billets achetés à temps pour l'événement. Dans les cas rares où un problème surviendrait et que le vendeur d'origine du billet n’est plus en mesure de fournir les billets mis en vente, Tapalika fait , à sa seule et entière discrétion, une recherche de billets de remplacement équivalents et Vous les fournit sans coût additionnel. Si Tapalika n'est pas en mesure de trouver et Vous fournir des billets équivalents, un remboursement du coût des billets Vous sera proposé. La notion de billets de remplacement équivalents est définie par Tapalika, à sa seule et entière discrétion. Lorsque Vous vendez des billets sur Tapalika, Tapalika vous garantit que vous serez payé(e) pour votre vente, à condition que vous fournissiez exactement les mêmes billets que ceux que vous avez mis en vente et que l'acheteur des billets ait pu accéder à l'événement.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Tapalika Vous informe que la publication d’une Offre de Vente en violation des conditions définies dans les présentes Conditions Générales d’Utilisation est susceptible d’entraîner des poursuites pénales à l’encontre du Vendeur responsable de ladite publication dans certaines juridictions. Tapalika décline toute responsabilité quant à la publication par Vous d’Offres de Vente illicites ou d’Offres de Vente de Billets Interdits, autre que celle qui pourrait lui incomber du fait de son statut d’hébergeur. En mettant en Vente un Billet sur la Plateforme Tapalika et en acceptant à ce titre les présentes Conditions Générales d’Utilisation, Vous garantissez Tapalika contre tout recours, action en justice, dommages-intérêts et tous frais annexes auxquels Tapalika devrait faire face ou qui seraient mis à la charge de Tapalika du fait de Votre publication d’une Offre de Vente illicite sur la Plateforme Tapalika.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> 4.1 Faire une offre : Un Membre qui désire acheter un Billet doit tout d'abord consulter la Plateforme Tapalika afin de trouver les Billets correspondant à ses critères de recherches. Lorsque ces Billets ont été trouvés par l'Acheteur, il matérialise sa décision par l'intermédiaire d'une « offre » d'achat des Billets. Nous attirons votre attention sur le fait que Vous êtes seul responsable du choix des Billets que Vous souhaitez acquérir.
                                                    <br>
                                                    <br> En plaçant une « offre » d’achat, Vous, en tant qu'Acheteur, octroyez à Tapalika le droit de débiter du Prix de la Transaction votre carte de crédit ou de débit, votre compte PayPal ou votre compte bancaire pour l'achat des Billets choisis.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> 6.2 Violations, résiliation et suspension : Des actions pourront être prises si Nous les jugeons appropriées, Nous pourrons également, sans toutefois s'y limiter, émettre un avertissement, suspendre ou clore un service, refuser un accès, supprimer une offre ou Vous conseiller de modifier une Offre de Vente. Vous acceptez que les paiements qui Vous sont dus à la suite de ventes effectuées par l'intermédiaire de ce Site puissent être suspendus ou retardés. Tapalika ne sera pas obligé de Vous payer toute vente si Nous suspectons que cette vente a été illégale ou exécutée en violation de cet Accord. Lors de la clôture de votre compte, vos Offres de Vente seront supprimées du Site si Vous êtes un Vendeur et vos achats seront annulés si Vous êtes un Acheteur.
                                                    <br>
                                                    <br> 6.3 Divulgation d'informations : Vous acceptez que Tapalika fasse état, aux autorités règlementaires, aux autorités de régulation et/ou à tout tiers compétent, de toute activité dont elle soupçonne qu’elle constitue une violation à la loi. Tapalika coopérera afin de garantir que les auteurs de violations soient poursuivis conformément à la loi.
                                                    <br>
                                                    <br> 6.4 Exécution d'ajustements : Vous Nous autorisez à différer le paiement ou à débiter votre carte de crédit ou de débit, ou votre compte Paypal, dans le cadre de l’autorisation de prélèvement que Vous Nous accordez, de tout montant que Vous Nous devrez si (a) un ajustement est effectué du fait de l’exécution de notre garantie Tapalika ; (b) Nous soupçonnons qu’une fraude ou un autre acte illégal a été commis lors des activités de vente ou d'achat et si une autorité compétente Nous fait la demande de différer le paiement ou de débiter votre moyen de paiement à titre provisoire ; (c) Vous ne livrez pas les mêmes Billets que ceux que Vous avez mis en vente sur le Site et dont la transaction a été confirmée ; (d) Vous adressez des objets promotionnels à un Acheteur ; ou (e) si Vous Nous devez de l'argent. Si l'une des situations citées devait se produire, Nous Nous réservons le droit de déduire de votre paiement le montant que Vous Nous devez.
                                                    <br>
                                                    <br> 7.1 Non garantie : À l'exception des garanties explicites déclarées dans cet Accord, Tapalika fournit les logiciels, le Site et les Services « tels qu'ils sont présentés » et « selon leur disponibilité » sans aucune garantie de quelque sorte que ce soit. Tapalika n'offre aucune garantie concernant ses logiciels, les Billets, les événements, les Services que Tapalika offre, ou la bonne exécution des promesses des Vendeurs ou des Acheteurs au-delà des garanties légales telles que prévues par les textes applicables. En particulier, Tapalika décline toute garantie, qu'elle soit explicite, obligatoire ou implicite, y compris et sans réserve(s), les garanties de qualité, de titre, de non violation des droits de tiers, etc. autant que la réglementation applicable le permet.
                                                    <br>
                                                    <br> 7.2 Renonciation des dommages indirects/limite de responsabilité : Sauf dans le cas où elle aurait été dûment informée de l’existence d’un contenu illicite au sens de la législation en vigueur, et n’aurait pas agi promptement pour le retirer, Tapalika ne peut pas être tenue pour responsable ni du contenu ou des actions (ou absence d'action) des Membres, ni des Billets qu'ils mettent en vente. Tapalika décline expressément toute responsabilité pour toute perte de profits, y compris, sans toutefois s'y limiter, tous dommages-intérêts particuliers ou exemplaires, tous dommages indirects ou tous dommages accessoires pouvant résulter des Services, du Site ou de la suspension, de la clôture ou du mauvais fonctionnement des Services ou du Site. La responsabilité de Tapalika envers Vous ou quiconque en toute circonstance, se limite au plus petit des deux montants suivants : (a) 200 €, et (b) la valeur totale de tous les Billets et autres articles que Vous avez achetés et/ou vendus par l'intermédiaire de Tapalika au cours de l'action ayant prétendument engendré la responsabilité. En aucun cas Tapalika ne saurait être tenue responsable de coûts supplémentaires encourus par votre achat de Billets auprès d'un tiers en contrepartie de Billets que Vous n'avez pas pu acheter sur le Site.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> 7.4 Renonciation : Vous reconnaissez expressément que Tapalika n’est pas impliquée dans les transactions réelles entre les Acheteurs et les Vendeurs. En cas de litige avec un ou plusieurs Membres, sauf dans le cas où Tapalika aurait été dûment informée de l’existence d’un contenu illicite au sens de la législation en vigueur, et n’aurait pas agi promptement pour le retirer, Vous Nous dégagez de toute responsabilité (ainsi que nos administrateurs, directeurs, agents, sociétés liées et associées, joint ventures et employés) pour toute réclamation et tout dommage (présent ou futur) de tout type ou nature, connu ou non, résultant de manière directe ou indirecte de ces litiges.
                                                    <br>
                                                    <br> 7.5 Indemnité fiscale : Vous reconnaissez que Tapalika n’est aucunement responsable de l'exactitude ou de la pertinence des paiements d'impôts ou taxes à une entité quelconque de votre part. Vous Vous engagez à indemniser Tapalika de tous dommages, frais, intérêts et dépenses (y compris les honoraires raisonnables d'avocats) et (le cas échéant) quelconque société mère, succursale, société affiliée, membres, directeurs, agents et employés, provenant d'un tiers ou d'un gouvernement qui implique ou concerne (i) toute obligation fiscale internationale, nationale, régionale ou locale ou tout montant dû conformément à tout décret, toute ordonnance, toute loi ou règlementation fiscaux ou (ii) tout litige sur le statut fiscal de Tapalika.
                                                    <br>
                                                    <br> 7.6 Indépendance des parties : Vous et Tapalika êtes des parties indépendantes, et aucune agence, aucun partenariat, aucune co-entreprise, aucune relation employeur-employé ou franchiseur-franchisé n'est voulu ou créé par cet Accord.
                                                    <br>
                                                    <br> 7.7 Informations provenant de tiers : Nous ne contrôlons pas les informations fournies sur ce Site par des utilisateurs ou les Membres. Il est possible que Vous trouviez que les informations provenant de tiers soient préjudiciables, inexactes ou décevantes. Veuillez faire preuve d'attention lorsque Vous utilisez le Site et n'oubliez pas la présence de risques d'escroquerie. Lorsque Vous utilisez ce Site, Vous reconnaissez ces risques et acceptez que Tapalika ne pourra être tenue responsable des actes ou omissions des utilisateurs du Site ni des Membres.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> Si, pour une quelconque raison, Vous ne voulez plus les Billets que Vous avez commandés, Nous Vous invitons à les revendre sur notre Site. Pour en savoir plus sur la mise en vente de Billets sur Tapalika, rendez-Vous sur <a href="#">www.Tapalika.com</a>
                                                    <br>
                                                    <br> 7.9 Modification ou suspension du Site : Tapalika se réserve le droit à tout moment de modifier ou d'arrêter, temporairement ou de manière permanente, le Site ou toute partie du Site avec ou sans préavis. Vous acceptez, dans le cadre de cet Accord, que Nous ne pourrons être tenus responsables envers Vous ou tout tiers de toute modification, suspension ou arrêt du Site ou de quelconque de ces Services, pour quelque raison que ce soit. Nous ne garantissons pas un accès continu, ininterrompu ou sûr à nos Services, et le fonctionnement de notre Site peut être altéré à cause de nombreux facteurs hors de notre contrôle. En outre, il est possible que le Site ne soit pas disponible pendant certaines périodes car il peut être mis à jour ou modifié. Le Site, pendant cette période, sera temporairement indisponible.
                                                    <br>
                                                    <br> 7.10 Avis : Sauf indication explicite contraire de la part de Tapalika, tous les avis et notification que Vous souhaitez adresser à Tapalika doivent être envoyés par l'intermédiaire du formulaire de courrier électronique mis à disposition sur le Site sous le lien Contactez-nous. Notre adresse postale est 160 Greentree Drive, Suite 101, Dover, Delaware, Country of Kent, 19904, Madagascar d’Amérique.
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br> 8.1 Règlement des litiges : Si, après avoir reçu les Billets, un Acheteur n'était pas satisfait d’une quelconque étape de l'achat, il devra suivre les procédures de recours indiquées dans la garantie Tapalika.
                                                    <br>
                                                    <br> 8.2 Droit de propriété intellectuelle : Vous reconnaissez et acceptez que (i) nos brevets, marques commerciales, appellations commerciales, marques de service, copyrights et autres droits de propriété intellectuelle (collectivement « la propriété intellectuelle ») sont et doivent être notre unique propriété, et que (ii) rien dans cet Accord ne Vous confère de droits de propriété ou de droits de licence dans notre propriété intellectuelle. Par ailleurs, Vous ne devez ni à présent, ni à l'avenir, contester la validité de la propriété intellectuelle de Tapalika.
                                                    <br>
                                                    <br> 8.3 Copyright : Copyright © Tapalika Entertainment Inc 2017. Les logiciels et le Site, y compris notamment, tous les textes, tous les graphiques, tous les logos, tous les boutons, toutes les images, tous les clips audio, et tous les programmes informatiques, constituent la propriété de Tapalika ou de ses fournisseurs, et ils sont protégés par les lois internationales et nationales sur le copyright, la marque de commerce ou d'autres lois sur la propriété intellectuelle. La compilation (c'est-à-dire la collecte, l'organisation et l'assemblage) de tout le contenu du Site est réservée exclusivement à Tapalika et elle est protégée par les lois internationales et nationales sur le copyright. La reproduction, la modification, la distribution, la transmission, la réédition, l'affichage ou l'exécution des logiciels ou du contenu du Site sont strictement interdits.
                                                    <br>
