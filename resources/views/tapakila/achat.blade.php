        ...
        <div class="row performe">
            <div class="col-md-12">
                <div class="about-bg">
                    ...
                    <p>Le billet électronique est disponible sur certains événements réservés sur internet. À la différence du billet traditionnel, le billet électronique est un billet imprimable chez soi en couleur ou en noir et blanc à partir de votre imprimante relié à votre ordinateur. Il utilise un code unique et différent pour chaque billet. Chaque billet électronique est scanné à l’entrée de la salle et sa validité est contrôlée. 
                    Donc, si vous achetez deux billets électroniques, vous imprimerez deux billets sur du papier format A4 blanc et vierge recto/verso.</p><br>
                    ...
                    <p><strong>4</strong>	- Selectionez la quantité de billets désirée</p>
                    <p><strong>5</strong>	- Choisissez vos billets parmi les listings disponibles</p>
                    <p><strong>6</strong>	- Suivez les différentes étapes –  vérifiez que votre adresse email est correct </p>
                    <p><strong>7</strong>	- Entrer votre réponse à la question sécrète s’il est mentionnée, cette question sert à vous authentifier à l’entrée de la salle.</p>
                    <p><strong>8</strong>	- Verifiez les détails de votre commande pour vous assurez que tout vous convient </p>
