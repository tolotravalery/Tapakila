    ...
    <div id="section" style="width:100%;height:400px;background:white;">
        ...
        <div id="section-text" style="position:relative;padding-left:50px;padding-right:50px">
            ...
            <div id="row1" style="padding-top:30px;">
                Bonjour {{$user->name}},
                <p> La mise à jour de votre événement est réussie.</p>
            ...
            <div id="row3" style="padding-top:170px;">
                ...
                Pour consulter votre événement <strong style="font-style:italic; color:red;"><a href="https://leguichet.mg/event/show/'.$event->id" style="text-decoration:underline;color:#d70506;">cliquez ici</a></strong>
            </div>
