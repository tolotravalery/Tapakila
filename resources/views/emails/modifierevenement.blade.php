...
<div class="cp" style="position:relative;width:800px;margin:auto;height:auto;">
    ...
    <div class="header" style="position:relative;width:100%;height:50px;margin:auto;background:#d70506 ;top:10px;">
        <div class="message" style="position:absolute;left:350px;font-style:bold;color:white;width:100px;top:15px;"><b>SUCCES</b></div>
    </div>
...
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0" style="margin-top:-20px">
    <tr>
        <td align="center">
            ...
            <p style="font-size: 14px;color:#333;padding-left:20px;padding-top:0px;width:auto;">La mise à jour de votre événement est réussie.</p>
