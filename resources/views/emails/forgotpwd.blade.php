                            ...
                            <tr>
                                <td class="content-cell">
                                    <div style="background-color: white; margin-top: 30px; padding: 20px 25px 20px 25px;">
                                        ...
                                        <p style="font-size: 14px;color:#333;font-family:Lucida Console;">Vous voulez changer votre mot de passe ? pas de problème !</p>
                                        <p style="font-size: 14px;color:#333;font-family:Lucida Console;">Pour avoir un nouveau mots de passe, cliquer sur le bouton ci-dessous. </p><br>
