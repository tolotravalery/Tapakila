                            ...
                            <tr>
                                <td class="content-cell">
                                    <div style="background-color: white; margin-top: 30px; padding: 20px 25px 20px 25px;">
                                        <img class="logoactivate" src="{{url('/')}}/public/img/logo.png" title="Tapakila">
                                        <hr class="border-logo">
                                        <h2><b style=" color:#333;margin-top: 20px; margin-bottom: 10px;font-size: 30px;word-wrap: break-word;font-weight: 700;">Bonjour,</b></h2>
