                                        ...
                                        <tr>
                                            <td align="center">
                                                <div style="background-color: white;margin-top: 84px;padding: 20px 30px 20px 30px;overflow: hidden;margin-bottom: 83px;border-radius: 3px;">
                                                    <h4 style="color: grey; padding-top: 20px;">Félicitation! Votre
                                                        achat est effectué avec succès</h4>
                                                    @php($somme=0)
                                                    @foreach($data as $d)
                                                        @php
                                                        ...
                                                        <table class="content" width="100%" cellpadding="0"
                                                            ...
                                                            <tr style="">
                                                                ...
                                                                <td style="color: grey;font-size: 12px;">
                                                                    <p>Nombre de ticket : {{count($d['tapakila'])}}</p>
                                                                    <p>
                                                                        Prix: {{$d['ticket']->price}}
                                                                        AR</p>
                                                    ...
                                                    <table class="content" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <p>Leguichet vous remercie de votre fidélité</p>
                                                                <p>Pour tout information : <a href="www.leguichet.mg">www.leguichet.mg</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
