...
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0" style="margin-top:-20px">
    <tr>
        <td align="left">
            ...
            <p style="font-size: 14px;color:#333;padding-left:50px;padding-top:0px;"><strong>Vous y êtes presque !</strong> Cliquez sur le lien ci-dessous pour activer votre compte.</p>

            <div style="  text-align: center;position: relative;min-height: 1px;margin-left: auto; margin-right: auto;width: 20%;">
                <a href="{{$actionUrl}}" style=" display:block;text-decoration: none;background-color: black; color: white;padding: 10px 16px;font-size: 18px; line-height: 1.3333333;border-radius: 6px; "> Activer </a>
            </div>
    ...
    <div class="row">
        <div class="col-lg-offset-3 col-lg-6">
            <div style=" color: white;text-align: center;background-color: #d70506;font-size: 16px;padding: 1px;font-family:sans-serif;">
                <p>Pour toutes questions, consultez <a style="text-decoration:underline;color:white !important" href="www.leguichet.mg">faq</a> </p>
            </div>
        </div>
    </div>
</div>
