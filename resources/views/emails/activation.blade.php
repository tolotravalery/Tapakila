                            ...
                            <tr>
                                <td class="content-cell">
                                    <div style="background-color: white; margin-top: 30px; padding: 20px 25px 20px 25px;">
                                        ...
                                        <p style="font-size: 14px;color:#333;font-family:Lucida Console;">Nous sommes prêts à activer votre compte. Il nous suffit de vérifier que cet adresse e-mail est bien le votre.</p>
                                        <p style="font-size: 14px;color:#333;font-family:Lucida Console;">Après cela, vous pouvez commander , acheter ou ajouter à votre panier vos évènement favoris. </p><br>
