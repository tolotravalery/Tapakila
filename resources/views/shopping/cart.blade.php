...
@section('content')
    ...
    <div class="container">
        <p><a href="{{ url('/shopping/shop') }}">Home</a> / Cart</p>
        <h1>Your Cart</h1>
        ...
        @if (sizeof(Cart::content()) > 0)
                ...
                @foreach (Cart::content() as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ url('shopping/switchToWishlist', [$item->rowId]) }}" method="POST"
                                  class="side-by-side">
                                {!! csrf_field() !!}
            ...
            <a href="{{url('shopping/checkout',[Cart::total()])}}" class="btn btn-success btn-lg">Proceed to
                Checkout</a>
