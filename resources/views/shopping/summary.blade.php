...
@section('content')
                ...
                <div class="board">
                    <div class="board-inner">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="active" id="li_settings">
                                ...
                                <div class="bgwhite">
                                    ...
                                    <p class="text-center">
                                        <a href="#messages" data-toggle="tab"
                                           class="btn btn-success btn-outline-rounded green"
                                           onClick="change1Page('messages','settings')">
                                            <span style="margin-left:10px;"
                                                  class="glyphicon glyphicon-circle-arrow-left"></span>
                                            Précédent </a>
                                        ...
                                        <div class="resume-paiment">
                                                    ...
                                                    <div class="panel panel-primary filterable">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        Mr/Mme/Mlle {{$checkout->getAdresseFacturation()['name'] }}
                                                                        <br/>
                                                                        {{$checkout->getAdresseFacturation()['adresse']}}
                                                                        <br/>
                                                                        {{$checkout->getAdresseFacturation()['city']}}
                                                                        <br/>
                                                                        {{$checkout->getAdresseFacturation()['phone']}}
                                                                        <br/>
                                                    ...
                                                    <div class="panel panel-primary filterable">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        {{$checkout->getAdresseLivraison()['mail']}}
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            <section id="mode-paiement">
                                                <div class="row">
                                                    <div class="panel panel-primary filterable">
                                                        <div class="panel-heading">
                                                            <h3 class="panel-title">Mode de Payement</h3>
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                <tbody>
                                                                <tr>
                                                                    <td>
                                                                        @if($checkout->getMethodePayement() == 'Airtel Money')
                                                                            <img src="{{url('/img/airtel-money.png')}}"
                                                                                 class="mode">
                                                                        @elseif($checkout->getMethodePayement() =='MVola')
                                                                            <img src="{{url('/img/mvola.jpg')}}"
                                                                                 class="mode">
                                                                        @elseif($checkout->getMethodePayement() == 'Orange Money')
                                                                            <img src="{{url('/img/orangemoney.png')}}"
                                                                                 class="mode">
                                                                        @endif
                                                                    </td>
                                                                </tr>
    ...
    <form action="{{url('/shopping/checkout/save',['checkout' => 'checkout'])}}" method="post" id="form_checkout_2">
        {!! csrf_field() !!}
        <input type="hidden" name="payement_mode" value="{{$checkout->getMethodePayement()}}">
    </form>
@endsection
