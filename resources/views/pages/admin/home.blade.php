...
@section('specificCss')
    <link rel='stylesheet' href='{{url('/')}}/public/admin-assets/fullcalendar/fullcalendar.css'/>
@endsection
@section('message')
    @if(count($alert) > 0)
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">EVENEMENTS</span>
                        <span class="info-box-number">{{$all_events->count()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">ORGANISATEURS</span>
                        <span class="info-box-number">{{$nombreOrganisateur}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{$nombrePayment}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
...
@section('specificScript')
    <script src='{{url('/')}}/public/admin-assets/fullcalendar/lib/moment.min.js'></script>
    <script src='{{url('/')}}/public/admin-assets/fullcalendar/fullcalendar.js'></script>
            ...
            $('#calendar').fullCalendar({
                ...
                events: [
                    @foreach($all_events as $event)
                        {
                            title: '{{$event->title}}',
                            start: '{{\Carbon\Carbon::parse($event->date_debut_envent)->format('Y-m-d')}}',
                            end: '{{\Carbon\Carbon::parse($event->date_fin_event)->format('Y-m-d')}}'
                        },
                    @endforeach
                ]
            })
