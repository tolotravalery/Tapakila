            ...
            <div class="box-body no-padding">
                <div class="mailbox-read-info">
                    ...
                    <h5>{{--From: help@example.com--}}
                        {{ \Carbon\Carbon::parse($alrt->created_at)->format('D d M Y H:i')}}
                        ({{$alrt->created_at->diffForHumans()}})</h5>
                </div>
                <div class="mailbox-read-message">
                    ...
                    <p>Merci,<br>L'équipe Leguichet.mg </p>
                </div>
                ...
                <ul class="mailbox-attachments clearfix">
                    <li>
                        ...
                        <div class="mailbox-attachment-info">
                            <a href="{{url('/admin/events/en-cours')}}" class="mailbox-attachment-name"><i
