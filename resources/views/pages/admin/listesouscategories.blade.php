                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                ...
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <span class="sr-only">
                                        Show Sous Categories Management Menu
                                    </span>
                                </button>
                                ...
                                @foreach($souscategories as $souscategory)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{$souscategory->category->title}}
                                        </td>
                                        <td class="hidden-sm hidden-xs hidden-md">{{$souscategory->created_at}}</td>
                                        <td class="hidden-sm hidden-xs hidden-md">{{$souscategory->updated_at}}</td>
                                        <td>
                                            {!! Form::open(array('url' => 'users/' . $souscategory->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success btn-block"
                                               href="{{ URL::to('users/' . $souscategory->id) }}" data-toggle="tooltip"
                                               title="Show">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info btn-block"
                                               href="{{ URL::to('users/' . $souscategory->id . '/edit') }}"
