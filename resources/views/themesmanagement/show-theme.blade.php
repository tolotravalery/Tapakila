                    ...
                    <div class="panel-body">
                        <div class="well well-sm">
                            ...
                            <ul class="list-group list-group-responsive theme-details-list margin-bottom-3">
                                ...
                                @if($theme->link != null)
                                    <li class="list-group-item"><strong>{{ trans('themes.showLink') }}</strong>
                                        <span> <a href="{{$theme->link}}" target="_blank" data-toggle="tooltip"
                                ...
                                <ul class="list-group">
                                    @foreach ($themeUsers as $themeUser)
                                        <li class="list-group-item"><i class="fa fa-user fa-fw margin-right-1"
                                                                       aria-hidden="true"></i> {{ $themeUser->name }}
                                        </li>
                                    @endforeach
                                </ul>
                            @endif
                            ...
                            <div class="col-xs-6">
                                <a href="/themes/{{$theme->id}}/edit" class="btn btn-small btn-info btn-block">
                                    <i class="fa fa-pencil fa-fw" aria-hidden="true"></i> Edit<span
                                            class="hidden-xs hidden-sm"> this</span><span
                                            class="hidden-xs"> Theme</span>
                                </a>
                            </div>
