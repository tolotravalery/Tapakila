            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="/themes/{{$theme->id}}" class="btn btn-primary btn-xs pull-right"
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('status') ? ' has-error ' : '' }} @if($theme->id == 1) disabled @endif ">
                            ...
                            <div class="col-md-9">
                                <label class="switch {{ $themeActive['checked'] }}" for="status">
                                    <span class="active"><i
                                                class="fa fa-toggle-on fa-2x"></i> {{ trans('themes.statusEnabled') }}</span>
                                    <span class="inactive"><i
                                                class="fa fa-toggle-on fa-2x fa-rotate-180"></i> {{ trans('themes.statusDisabled') }}</span>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <label class="input-group-addon" for="name"><i class="fa fa-fw fa-pencil }}"
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('link') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <label class="input-group-addon" for="link"><i
                                                class="fa fa-fw fa-link fa-rotate-90 }}" aria-hidden="true"></i></label>
                                </div>
                                @if ($errors->has('link'))
                                    <span class="help-block">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('notes') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <label class="input-group-addon" for="notes"><i class="fa fa-fw fa-pencil }}"
                                                                                    aria-hidden="true"></i></label>
                                </div>
                                @if ($errors->has('notes'))
                                    <span class="help-block">
