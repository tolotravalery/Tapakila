            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        {{ trans('themes.themesTitle') }}
                        <strong>{{ count($themes) }}</strong> {{ trans('themes.themes') }}
                            ...
                            <table class="table table-striped table-condensed data-table">
                                ...
                                @foreach($themes as $aTheme)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <span class="label label-{{ $themeCountClass }}"
                                        ...
                                        <td class="hidden-xs hidden-sm hidden-md">
                                            <a href="{{$aTheme->link}}" target="_blank" data-toggle="tooltip"
                                               title="Go to Link">
                                                {{$aTheme->link}}
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-success btn-block"
                                               href="{{ URL::to('themes/' . $aTheme->id) }}" data-toggle="tooltip"
                                               title="{{ trans('themes.themesBtnShow') }}">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info btn-block"
                                               href="{{ URL::to('themes/' . $aTheme->id . '/edit') }}"
                                               data-toggle="tooltip" title="{{ trans('themes.themesBtnEdit') }}">
