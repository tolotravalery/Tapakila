...
$(document).on('click', '.number-spinner2 button', function () {
    var total = parseInt($('#prixUnit1').html()) + parseInt($('#prixUnit2').html());
    var btn = $(this), oldValue = btn.closest('.number-spinner2').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
            var prixUnit1 = 4000 * newVal;
...
$(document).on('click', '.number-spinner3 button', function () {
    var btn = $(this), oldValue = btn.closest('.number-spinner3').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
...
$(document).on('click', '.number-spinner4 button', function () {
    var total = parseInt($('#prixUnit3').html()) + parseInt($('#prixUnit4').html());
    var btn = $(this), oldValue = btn.closest('.number-spinner4').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
...
$(document).on('click', '.number-spinner5 button', function () {
    var btn = $(this), oldValue = btn.closest('.number-spinner5').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
...
$(document).on('click', '.number-spinner6 button', function () {
    var total = parseInt($('#prixUnit5').html()) + parseInt($('#prixUnit6').html());
    var btn = $(this), oldValue = btn.closest('.number-spinner6').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
...
$(document).on('click', '.number-spinner7 button', function () {
    var btn = $(this), oldValue = btn.closest('.number-spinner7').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
...
$(document).on('click', '.number-spinner8 button', function () {
    var total = parseInt($('#prixUnit7').html()) + parseInt($('#prixUnit8').html());
    var btn = $(this), oldValue = btn.closest('.number-spinner8').find('input').val().trim(), newVal = 0;
    if (btn.attr('data-dir') == 'up') {
        if (oldValue < 20) {
            newVal = parseInt(oldValue) + 1;
