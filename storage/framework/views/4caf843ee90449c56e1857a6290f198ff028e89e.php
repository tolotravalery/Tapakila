                                    ...
                                    <div class="tab-pane fade  edit_profile">
                                            ...
                                            <div class="col-sm-5 col-sm-offset-4 margin-bottom-1">
                                                <div class="row" data-toggle="buttons">
                                                    <div class="col-xs-6 right-btn-container">
                                                        <label class="btn btn-primary <?php if($user->profile->avatar_status == 0): ?> active <?php endif; ?> btn-block btn-sm"
                                                    ...
                                                    <div class="col-xs-6 left-btn-container">
                                                        <label class="btn btn-primary <?php if($user->profile->avatar_status == 1): ?> active <?php endif; ?> btn-block btn-sm"
                                                               data-toggle="collapse"
                                        ...
                                        <div class="form-group has-feedback <?php echo e($errors->has('theme') ? ' has-error ' : ''); ?>">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <span class="glyphicon <?php echo e($errors->has('theme') ? ' glyphicon-asterisk ' : ' '); ?> form-control-feedback"
                                        ...
                                        <div class="form-group has-feedback <?php echo e($errors->has('location') ? ' has-error ' : ''); ?>">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <span class="glyphicon <?php echo e($errors->has('location') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback"
                                                      aria-hidden="true"></span>
                                        ...
                                        <div class="form-group has-feedback row <?php echo e($errors->has('first_name') ? ' has-error ' : ''); ?>">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    <label class="input-group-addon" for="first_name"><i
                                                                class="fa fa-fw <?php echo e(trans('forms.create_user_icon_firstname')); ?>"
                                                                aria-hidden="true"></i></label>
                                                </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="deleteAccount" class="tab-pane fade">
                                                ...
                                                <p class="margin-bottom-2 text-center">
                                                    ...
                                                    <u><strong>permanent</strong></u> and <u><strong>cannot</strong></u>
                                                    be undone.
                                                    <i class="fa fa-exclamation-triangle fa-fw" aria-hidden="true"></i>
                                                </p>
...
resources/views/profiles/edit-old.blade.php:500
