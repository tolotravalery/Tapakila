                ...
                <div class="col-sm-2 gauche">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <img src="<?php echo e(url('/')); ?>/img/user.png" id="sary">
                ...
                <div class="col-sm-10 droite">
                    <div id="div_compte">
                        ...
                        <div class="form-group contre">
                            ...
                            <?php echo Form::text('name', old('name'), array('id' => 'name', 'class' => 'form-control forme', 'placeholder' => trans('forms.ph-username'))); ?>

                            <?php echo Form::label('first_name', 'Prénom'); ?>

                            <?php echo Form::text('first_name', old('first_name'), array('id' => 'first_name', 'class' => 'form-control forme', 'placeholder' => trans('forms.create_user_ph_firstname'))); ?>

                            <?php echo Form::label('email', 'E-mail'); ?>

                            <?php echo Form::text('email', old('email'), array('id' => 'email', 'class' => 'form-control forme', 'placeholder' => trans('forms.ph-useremail'))); ?>

                            <label for="usr">Changer mot de passe</label>
                            <?php echo Form::password('password', array('id' => 'password', 'class' => 'form-control forme ', 'placeholder' => trans('forms.create_user_ph_password'), 'autocomplete' => 'new-password')); ?>
                            ...
                            <?php endif; ?>
                            <?php echo Form::password('password_confirmation', array('id' => 'password_confirmation', 'class' => 'form-control forme', 'placeholder' => trans('forms.create_user_ph_pw_confirmation'))); ?>
